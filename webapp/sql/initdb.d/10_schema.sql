...
CREATE INDEX livestream_view_history_live_id ON livestream_viewers_history (livestream_id);
...
CREATE INDEX ng_words_live_id ON ng_words (livestream_id);
...
CREATE INDEX reactions_live_id ON reactions (livestream_id);
