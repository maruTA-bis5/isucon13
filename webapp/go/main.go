...
func connectDB(logger echo.Logger) (*sqlx.DB, error) {
	...
	db.SetMaxOpenConns(10) // TODO 増やしてもいいかも
...
func (j goccyJson) Serialize(c echo.Context, i interface{}, indent string) error {
...
func (j goccyJson) Deserialize(c echo.Context, i interface{}) error {
